const ko = {
  ...
  tripPickerOpenTrip: '이 여행 열기',
  tripPickerOpenTripAria: '선택한 여행 JSON을 불러와 재생합니다',
...
const en: Translations = {
  ...
  tripPickerOpenTrip: 'Open this trip',
  tripPickerOpenTripAria: 'Load the selected trip and start replay',
