const ko = {
  ...
  gpxEditor: 'GPX 편집',
  navHomeAria: '홈 — 여행 선택 화면으로 돌아갑니다',
  loadTripPrompt: '여행을 불러와 주세요',
  loadTripDesc:
    '지도에서 경로를 누르거나 목록에서 여행을 고른 뒤, 아래에서 「이 여행 열기」를 누르세요. JSON 파일은 설정에서 불러올 수 있습니다.',
  tripPickerMapHint:
    '지도의 색 경로나 아래 목록에서 여행을 고르면, 해당 GPS 궤적이 화면 중앙에 맞게 이동합니다.',
  tripPickerNoTrackHint: '저장된 여행에 표시할 GPS 궤적이 없습니다. 아래 목록에서 선택하세요.',
  tripPickerWebglListOnly: '지도를 쓸 수 없어 목록에서만 선택할 수 있습니다. 여행을 고른 뒤 「이 여행 열기」를 누르세요.',
  tripPickerSelectedLabel: '선택됨',
  tripPickerNoneSelected: '여행을 지정해 주세요.',
  tripPickerOpenTrip: '블로그 열기',
  tripPickerOpenTripAria: '선택한 여행의 블로그 글로 이동합니다.',
  tripPickerSourceCount: (n: number) => `블로그 글 ${n}개`,
  tripPickerNoBlogPosts: '이 여행에 연결된 블로그 글이 없습니다.',
  tripPickerBlogSourcesTitle: '블로그 글 선택',
  tripPickerBlogSourcesDesc: (label: string) => `${label}에 연결된 글을 선택하세요.`,
  tripPickerBlogPhotosCount: (n: number) => `사진 ${n}장`,
  ...
  openSourcePostTitle: '원본 블로그 글 열기',
  prev: '이전',
  next: '다음',
...
const en: Translations = {
  ...
  navHomeAria: 'Home — return to trip picker',
  loadTripPrompt: 'Load a trip to get started',
  loadTripDesc:
    'Click a route on the map or pick a trip in the list, then press “Open this trip”. You can load a JSON file from Settings.',
  tripPickerMapHint:
    'Pick a trip from a colored route or the list below; the map pans and zooms so that GPS track is centered.',
  tripPickerNoTrackHint: 'No GPS track preview for saved trips. Choose from the list below.',
  tripPickerWebglListOnly:
    'Map is unavailable. Choose a trip from the list, then press “Open this trip”.',
  tripPickerSelectedLabel: 'Selected',
  tripPickerNoneSelected: 'Choose a trip.',
  tripPickerOpenTrip: 'Open blog post',
  tripPickerOpenTripAria: 'Open the selected trip in its source blog post',
  tripPickerSourceCount: (n: number) => `${n} blog posts`,
  tripPickerNoBlogPosts: 'No blog posts are linked to this trip.',
  tripPickerBlogSourcesTitle: 'Choose a blog post',
  tripPickerBlogSourcesDesc: (label: string) => `Select one of the linked posts for ${label}.`,
  tripPickerBlogPhotosCount: (n: number) => `${n} photos`,
  ...
  openSourcePostTitle: 'Open source blog post',
  prev: 'Prev',
  next: 'Next',
